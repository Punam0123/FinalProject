            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                return Card(
                  ...
                  child: ListTile(
                    leading: Icon(Icons.local_parking, color: Colors.teal, size: 40),
                    title: Text('Parking Slot ${index + 1}'),
                    subtitle: Text('Available: Yes | Price: \$5/hr'),
                    trailing: ElevatedButton(
                      onPressed: () {}, // Implement booking functionality
